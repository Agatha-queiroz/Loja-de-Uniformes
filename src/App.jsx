...
function App() {
  ...
  function selecionarTamanho(index, tamanho) {
    const novos = [...cartItems];
  ...
  function atualizarMedida(index, campo, valor) {
    const novos = [...cartItems];
    ...
    <div>
      ...
      {isCartOpen && (
        <SideBar
          ...
          atualizarMedida={atualizarMedida}
        />
      )}
      ...
      <div className="container">
        <h1>Uniformes Personalizados UniStyle</h1>
        <div className="form">
          <h2>{editandoId ? "Editar uniforme" : "Cadastrar Uniforme"}</h2>
